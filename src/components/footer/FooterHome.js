        ...
        <div className="row">
          ...
          <div className="col-3">
            ...
            <div className="mt-1 text-white d-flex">
              <p>
                {" "}
                <FaFacebook className="me-2" /> facebook.com/123job.org
              </p>
            </div>
            <div className="mt-1 text-white d-flex">
              <p>
                {" "}
                <FaInstagram className="me-2" /> @123job.org
              </p>
            </div>
            <div className="mt-1 text-white d-flex">
              <p>
                {" "}
                <FaYoutube className="me-2" /> youtube.com/123job.org
              </p>
            </div>
            <div className="mt-1 text-white d-flex">
              <p>
                {" "}
                <FaTwitter className="me-2" /> @123job.org
              </p>
            </div>
          </div>
        </div>
