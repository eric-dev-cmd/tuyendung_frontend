...
const DashBoardQTVCareer = () => {
  ...
  const getDataListFilters = async () => {
    const requestUrl = `http://localhost:4000/nganhNghes`;
    try {
  ...
  const confirmDeleteDrop = (id) =>
    Modal.confirm({
      title: "Bạn chắc chắn muốn xóa ngành nghề này?",
      // content: "first",
      onOk: async () => {
        try {
          const requestUrl = `http://localhost:4000/nganhNghes/${id}`;
                    ...
                    >
                      <div className="row">
                        ...
                        <div className="col-2 ms-3">
                          ...
                          >
                            <AiOutlinePlusCircle className="me-2" /> Thêm ngành
                            nghề
                          </Button>
                        </div>
                      </div>
...
export default DashBoardQTVCareer;
