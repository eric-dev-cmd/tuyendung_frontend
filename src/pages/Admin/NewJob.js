...
import FormPostNew4 from "./components/forms/FormPostNew4";
                  ...
                  <div className="col-8 my-2 bg-black">
                    <div className="bg-secondary px-2 py-3 rounded text-white">
                      <p className="text-underline">
                        <strong>Ví dụ:</strong> Tuyển nhân viên kinh doanh không
                        yêu cầu kinh nghiệm
                      </p>
                      <p className="text-underline">
                        <strong>Nên:</strong>{" "}
                      ...
                      >
                        {districts?.data?.districts &&
                          districts?.data?.districts.map((item, index) => (
                            <Select.Option
                              key={index}
                              value={item?.name + "-" + districts?.data?.name}
                            >
                              {item?.name}
                            </Select.Option>
                          ))}
                  ...
                  <div className="col-8 my-2 bg-black">
                    <div className="bg-secondary px-2 py-3 rounded text-white">
                      ...
                      <ul>
                        ...
                        <li>
                          Không điền form ứng tuyển hoặc đường dẫn tới website
                          khác
                        </li>
                      </ul>
                    </div>
              ...
              <>
                ...
                <div className="row">
                  ...
                  <div className="col-12 my-2 bg-black">
                    <div className="bg-secondary px-2 py-3 rounded text-white">
                      <p className="text-underline">
                        Các kỹ năng chuyên môn của ứng viên để đáp ứng nhu cầu
                        công việc, các kỹ năng được ưu tiên của ứng viên... vv
                      </p>
                      <p className="text-underline">
                        <strong>Ví dụ:</strong>{" "}
                        <ul>
                          <li>
                            Kinh nghiệm vận hành, bảo trì sửa chữa nhà xưởng,
                            tòa nhà trên 2 năm.
                          </li>
                          <li>Kinh nghiệm chuyên ngành Cơ điện trên 5 năm</li>
                          <li>
                            Tận dụng kiến thức kỹ thuật, đưa ra quyết định nhanh
                            chóng và giải quyết vấn đề. Tận dụng kinh nghiệm đã
                            tích lũy xác định vấn đề tiềm ẩn và giải quyết mọi
